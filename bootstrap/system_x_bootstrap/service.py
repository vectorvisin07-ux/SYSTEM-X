...
def register_platform_service(
    ...
    *,
    ...
    if before["unit_present"] or before["adapter_manifest_present"]:
        if all(before[key] for key in ("unit_present", "adapter_manifest_present", "operating_profile_present", "desired_state_present")):
            return {"changed": False, "state": "registered", "service_control_invoked": False}
