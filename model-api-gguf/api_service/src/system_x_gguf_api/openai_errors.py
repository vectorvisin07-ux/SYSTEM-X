...
OPENAI_ERROR_RESPONSES: dict[int | str, dict[str, Any]] = {
    ...
    413: {"model": OpenAIErrorResponse, "description": "request too large"},
    422: {"model": OpenAIErrorResponse, "description": "token budget exceeded"},
    429: {"model": OpenAIErrorResponse, "description": "rate or concurrency limit"},
