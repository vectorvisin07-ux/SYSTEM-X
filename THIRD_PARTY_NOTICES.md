...
The upstream `LICENSE`, notices, vendored dependencies, fixtures, documentation, and source-controlled assets are preserved at `model-api-gguf/llama.cpp`. Generated build output and the upstream `.git` database are not vendored.
